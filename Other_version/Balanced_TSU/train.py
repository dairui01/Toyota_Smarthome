...
parser.add_argument('-kernelsize', type=str, default='False')gitlab
...
if args.dataset == 'TSU':
    ...
    train_split = 'unsynchronised_balance_data_annotation.json'
    test_split = 'unsynchronised_balance_data_annotation.json'
    classes=34
    rgb_root = '/data/stars/user/rdai/smarthome_untrimmed/features/i3d_16frames_64000_SSD' # path of features extracted from I3D
