...
parser.add_argument('-json_type', type=str, default='old')
...
if args.dataset == 'TSU':
    ...
    train_split = './unbalanced_data_synchronised_footage.json'
    test_split = './unbalanced_data_synchronised_footage.json'
    classes=51
    rgb_root = '/data/stars/share/joint_view/synchronised_features'
